...
pub use platform::{
    ...
    ContainerRollupRequestPort, CorrelatedContainerRollupEvent, CorrelatedCpuThrottleEvent,
    CorrelatedDesktopAppearanceEvent, CorrelatedDirectoryUsageEvent, CorrelatedEvent,
    CorrelatedGpuEngineRowsEvent, CorrelatedHardwareInventoryEvent, CorrelatedMsrReadoutEvent,
    CorrelatedNpuInventoryEvent, CorrelatedPowerSupplyEvent, CorrelatedProcessAffinityEvent,
    CorrelatedProcessEvent, CorrelatedRaplPowerEvent, CorrelatedSensorEvent,
    CorrelatedServiceEvent, CorrelatedSessionEvent, CorrelatedSetupScriptEvent,
    CorrelatedShellEvent, CorrelatedSmartEvent, CorrelatedSmbiosMemoryEvent,
    CorrelatedStartupEvent, CorrelatedStorageHealthEvent, CorrelatedSystemTelemetryOutcome,
    CpuTelemetryRequest, CpuTelemetryRequestPort, CpuThrottleEvent, CpuThrottleRequest,
    CpuThrottleRequestPort, DesktopAppearanceEvent, DesktopAppearanceRequest,
    ...
    IntegrationFacets, MemoryTelemetryRequest, MemoryTelemetryRequestPort, MsrReadoutEvent,
    MsrReadoutRequest, MsrReadoutRequestPort, NetworkTelemetryRequest, NetworkTelemetryRequestPort,
    NpuInventoryEvent, NpuInventoryRequest, NpuInventoryRequestPort, PlatformClient, PlatformEvent,
    PlatformEventBatch, PlatformEventContext, PlatformEventPort, PlatformFacets, PlatformHandle,
    PowerFacets, PowerSupplyEvent, PowerSupplyRequest, PowerSupplyRequestPort,
    ProcessAffinityControlRequest, ProcessAffinityControlRequestPort, ProcessAffinityEvent,
    ProcessAffinityRequest, ProcessAffinityRequestPort, ProcessControlRequest,
    ProcessControlRequestPort, ProcessEnvironmentRequest, ProcessEnvironmentRequestPort,
    ProcessEvent, ProcessFacets, ProcessGpuRequest, ProcessGpuRequestPort, ProcessInsightFacet,
    ProcessInsightFacetEvent, ProcessInsightFacetState, ProcessInsightObservation,
    ProcessInsightUnavailable, ProcessInsightsProjection, ProcessInsightsProjectionApplyResult,
