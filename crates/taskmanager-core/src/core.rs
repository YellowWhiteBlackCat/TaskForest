...
pub use metrics::{
    ...
    NetworkAdapterType, NetworkMetrics, NetworkScalarObservations, NetworkTelemetryObservation,
    NetworkWirelessObservations, ObservationWireError, OptionalObservation,
    OptionalObservationState, PressureWindow, ProviderRuntimeState, RaplPackageRow,
    RaplPowerFailure, RaplPowerSnapshot, ResourcePressure, ScalarAvailability, ScalarObservation,
    ScalarObservationGroup, ScalarObservationSlot, SmartAvailability, SmbiosMemoryFailure,
    SmbiosMemorySnapshot, SmbiosModuleRow, StorageTelemetryObservation, SystemLoadAverage,
    SystemObservationState, SystemPressureSnapshot, SystemSnapshot, SystemTelemetryDomains,
    VirtualMemoryCommitObservations, aggregate_package_throttle_counters,
