...
fn snapshot_json_exports_network_value_freshness_and_optional_semantics() {
    ...
    network.apply_observations(
        ...
        NetworkScalarObservations {
            ...
            mtu_bytes: ScalarObservation::unavailable(FailureKind::TemporarilyUnavailable),
            tx_queue_len: ScalarObservation::unavailable(FailureKind::TemporarilyUnavailable),
            rx_drops: ScalarObservation::unavailable(FailureKind::TemporarilyUnavailable),
            tx_drops: ScalarObservation::unavailable(FailureKind::TemporarilyUnavailable),
            rx_errors: ScalarObservation::unavailable(FailureKind::TemporarilyUnavailable),
            tx_errors: ScalarObservation::unavailable(FailureKind::TemporarilyUnavailable),
            rx_overruns: ScalarObservation::unavailable(FailureKind::TemporarilyUnavailable),
            tx_overruns: ScalarObservation::unavailable(FailureKind::TemporarilyUnavailable),
        },
