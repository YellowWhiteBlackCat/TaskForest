...
pub enum Key {
    ...
    HealthNoData,
    ThermalZones,
    // Health device-summary and sensor-surface vocabulary. A shared product
    // term points its `code()` at the existing catalog key (no second shared
    // address); a phrase only this frontend renders carries its own code.
    Cpu,
    Memory,
    Swap,
    Disk,
    ...
    HealthVerdictOk,
    HealthObservedHint,
    HealthDeviceCountOne,
    HealthDeviceCountMany,
    HealthInterfaceCountOne,
    HealthInterfaceCountMany,
    HealthGpuCountOne,
    HealthGpuCountMany,
    HealthSystemValue,
    HealthThermalHeatmap,
    HealthSensorsThermal,
    HealthThermalCool,
    HealthThermalNormal,
    HealthThermalWarm,
    HealthThermalHot,
...
impl Key {
    ...
    pub const fn code(self) -> &'static str {
        match self {
            ...
            Key::WindowCapture => "window_capture.capture",
            ...
            Key::ThermalZones => "common.thermal_zones",
            Key::Cpu => "common.cpu",
            ...
            Key::HealthObservedHint => "health.observed_hint",
            Key::HealthDeviceCountOne => "health.device_count_one",
            Key::HealthDeviceCountMany => "health.device_count_many",
            Key::HealthInterfaceCountOne => "health.interface_count_one",
            Key::HealthInterfaceCountMany => "health.interface_count_many",
            Key::HealthGpuCountOne => "health.gpu_count_one",
            Key::HealthGpuCountMany => "health.gpu_count_many",
            Key::HealthSystemValue => "health.system_value",
            Key::HealthThermalHeatmap => "health.thermal_heatmap",
            Key::HealthSensorsThermal => "health.sensors_thermal",
            Key::HealthThermalCool => "health.thermal_cool",
            Key::HealthThermalNormal => "health.thermal_normal",
            Key::HealthThermalWarm => "health.thermal_warm",
            Key::HealthThermalHot => "health.thermal_hot",
            Key::HealthCpuPackage => "health.cpu_package",
            Key::HealthGpuIndex => "health.gpu_index",
            Key::HealthGpuIndexBrand => "health.gpu_index_brand",
...
const fn en(key: Key) -> &'static str {
    match key {
        ...
        Key::Health => "Health",
        Key::WindowCapture => "Capture window",
        Key::Export => "Export",
        Key::About => "About",
        Key::Close => "Close",
        ...
        Key::ThermalZones => "Thermal zones",
        Key::Cpu => "CPU",
        Key::Memory => "Memory",
        Key::Swap => "Swap",
        Key::Disk => "Disk",
        Key::Network => "Network",
        Key::Gpu => "GPU",
        Key::SystemDomain => "System",
        Key::HealthScore => "Health",
        Key::HealthUnavailable => "Unavailable",
        Key::HealthVerdictOk => "ok",
        Key::HealthObservedHint => "Observed samples only · Esc closes",
        Key::HealthDeviceCountOne => "{count} device · {model}",
        Key::HealthDeviceCountMany => "{count} devices · {model}",
        Key::HealthInterfaceCountOne => "{count} interface · {model}",
        Key::HealthInterfaceCountMany => "{count} interfaces · {model}",
        Key::HealthGpuCountOne => "{count} GPU · {model}",
        Key::HealthGpuCountMany => "{count} GPUs · {model}",
        Key::HealthSystemValue => "uptime {uptime} · {processes} processes · {threads} threads",
        Key::HealthThermalHeatmap => "Thermal Heatmap & Sensors",
        Key::HealthSensorsThermal => "Sensors & Thermal Health",
        Key::HealthThermalCool => "Cool",
        Key::HealthThermalNormal => "Normal",
        Key::HealthThermalWarm => "Warm",
        Key::HealthThermalHot => "Hot",
        Key::HealthCpuPackage => "CPU Package",
        Key::HealthGpuIndex => "GPU {index}",
        Key::HealthGpuIndexBrand => "GPU {index} ({brand})",
...
const fn zh(key: Key) -> &'static str {
    match key {
        ...
        Key::SystemDomain => "系统",
        Key::HealthScore => "健康度",
        Key::HealthUnavailable => "不可用",
        Key::HealthVerdictOk => "正常",
        Key::HealthObservedHint => "仅显示已观测样本 · Esc 关闭",
        Key::HealthDeviceCountOne => "{count} 个设备 · {model}",
        Key::HealthDeviceCountMany => "{count} 个设备 · {model}",
        Key::HealthInterfaceCountOne => "{count} 个接口 · {model}",
        Key::HealthInterfaceCountMany => "{count} 个接口 · {model}",
        Key::HealthGpuCountOne => "{count} 个 GPU · {model}",
        Key::HealthGpuCountMany => "{count} 个 GPU · {model}",
        Key::HealthSystemValue => "运行时间 {uptime} · {processes} 个进程 · {threads} 个线程",
        Key::HealthThermalHeatmap => "温度热图与传感器",
        Key::HealthSensorsThermal => "传感器与温度健康",
        Key::HealthThermalCool => "凉爽",
        Key::HealthThermalNormal => "正常",
        Key::HealthThermalWarm => "偏热",
        Key::HealthThermalHot => "过热",
        Key::HealthCpuPackage => "CPU 封装",
        Key::HealthGpuIndex => "GPU {index}",
        Key::HealthGpuIndexBrand => "GPU {index} ({brand})",
