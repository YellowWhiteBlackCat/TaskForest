...
impl From<&NetworkMetrics> for NetworkObservation {
    fn from(network: &NetworkMetrics) -> Self {
        Self {
            ...
            mtu_bytes: network.current_mtu_bytes(),
            tx_queue_len: network.current_tx_queue_len(),
            rx_drops: network.current_rx_drops(),
            tx_drops: network.current_tx_drops(),
            rx_errors: network.current_rx_errors(),
            tx_errors: network.current_tx_errors(),
            rx_overruns: network.current_rx_overruns(),
            tx_overruns: network.current_tx_overruns(),
            ...
            channel_width_mhz: network.current_channel_width_mhz(),
