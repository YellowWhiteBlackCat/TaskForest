//! Shared test-only scratch support: a unique per-process root under the
//! repository `.tmp/` (never the system temp dir). Integration-test children
//! of `tests/headless.rs` resolve this as `crate::test_support`.
